...
/**
 * Servlet implementation class DoEditCategory
 */
@WebServlet("/doEditCategory")
public class DoEditCategory extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String catname= (String)request.getParameter("txtCateName");
		try {
			cat.updateCategory(idcat, catname);
