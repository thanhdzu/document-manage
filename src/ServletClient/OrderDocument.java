...
/**
 * Servlet implementation class OrderDocument
 */
@WebServlet("/orderDocument")
public class OrderDocument extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] docs = request.getParameterValues("ckOrder");
		try {
			list = Document.getOrderDocument(docs);
		} catch (Exception e) {
