            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="doEditTeacher" method="POST">
                            <input type="hidden" name="idteach" value="${teacher.id_teacher}">
                             <div class="form-group">
                                <label>Teacher Name</label>
                                <input class="form-control" value="${teacher.teacher_name}" disabled placeholder="Please Enter Category Name" />
                            </div>
                            <div class="form-group">
                                <label>Teacher Name</label>
                            ...
                            <button type="submit" class="btn btn-default">Teacher Edit</button>
