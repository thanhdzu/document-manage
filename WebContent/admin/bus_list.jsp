                ...
                <div class="row">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="catetable">
                        ...
                        <c:forEach items="${busList}" var="bus" >
             				...
             				<td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="deleteBusiness?id=${bus.id_business}"> Xóa</a></td>
                            <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="editBusiness?id=${bus.id_business}">Sửa</a></td>
          					</tr>
       					</c:forEach>	
