                    ...
                    <table class="table table-striped table-bordered table-hover" id="usertable">
                        ...
                        <c:forEach items="${docList}" var="doc"> 
                        	<tr class="odd gradeX" align="center">
                                ...
                                <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="deleteDocument?id=${doc.id_document}"> Xóa</a></td>
                                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="editDocument?id=${doc.id_document}">Sửa</a></td>
                            </tr>
                        	</c:forEach>
                        </tbody>
                    </table>
