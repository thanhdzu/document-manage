            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="doEditNotice" method="POST">
                            <input type="hidden" name="idNotice" value="${notice.id_notice}">
                             <div class="form-group">
                                <label>Thông báo</label>
                                <input class="form-control" value="${notice.notice_info}" disabled placeholder="Please Enter Category Name" />
                            </div>
                            <div class="form-group">
                                <label>Thông báo mới</label>
                                <textarea class="form-control" name="txtNotice" id="editor1" placeholder="Điền thông báo" ></textarea>
                            </div>
