                ...
                <div class="row">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="catetable">
                        ...
                        <c:forEach items="${classList}" var="clas" >
             				...
             				<td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="deleteClass?id=${clas.id_class}"> Xóa</a></td>
                            <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="editClass?id=${clas.id_class}">Sửa</a></td>
          					</tr>
       					</c:forEach>	
