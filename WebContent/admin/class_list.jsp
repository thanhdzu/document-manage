                ...
                <div class="row">
                    ...
                    <form action="addClass" method="post">
                    	 <div class="form-group col-sm-5">
                                ...
                                <input class="form-control" name="txtClassName" placeholder="Please Enter Category Name" />
                    ...
                    <table class="table table-striped table-bordered table-hover" id="catetable">
                        ...
                        <c:forEach items="${classList}" var="clas" >
             				...
             				<td class="center">${clas.id_class}</td>
             				<td class="center">${clas.class_name}</td>
             				<td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="deleteClass?id=${clas.id_class}"> Delete</a></td>
                            <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="editClass?id=${clas.id_class}">Edit</a></td>
          					</tr>
       					</c:forEach>	
