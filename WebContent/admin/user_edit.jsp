                ...
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="doEditAccount" method="POST">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                          	 ...
                          	 <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="txtPass" id="txtPass" onkeyup="checkPasswordLenght();" placeholder="Please Enter Password" />
                                <p id="divCheckPasswordLenght" class="divCheckPasswordLenght"></p>
                            </div>
                            <div class="form-group">
                                <label>Nhập lại mật khẩu</label>
                                <input type="password" class="form-control" name="txtRePass" id="txtRePass" onkeyup="checkPasswordMatch();" placeholder="Please Enter RePassword" />
                            ...
                            <a href="${pageContext.request.contextPath}/userList">Quay lại</a>
                        <form>
