                ...
                <div class="row">
                    ...
                    <form action="addTeacher" method="post">
                    	 <div class="form-group col-sm-5">
                                ...
                                <input class="form-control" name="txtTeachName" placeholder="Please Enter Teacher Name" />
                                 <button type="submit" class="btn btn-default">Teacher Add</button>
                            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="catetable">
                        ...
                        <c:forEach items="${teachList}" var="teach" >
             				...
             				<td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="deleteTeacher?id=${teach.id_teacher}"> Delete</a></td>
                            <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="editTeacher?id=${teach.id_teacher}">Edit</a></td>
          					</tr>
       					</c:forEach>	
