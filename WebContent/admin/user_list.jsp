                    ...
                    <table class="table table-striped table-bordered table-hover" id="usertable">
                        ...
                        <c:forEach items="${userList}" var="user"> 
                        	<tr class="odd gradeX" align="center">
                                ...
                                <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="deleteAccount?id=${user.id_account}"> Delete</a></td>
                                <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="editAccount?id=${user.id_account}">Edit</a></td>
                            </tr>
                        	</c:forEach>
                        </tbody>
                    </table>
