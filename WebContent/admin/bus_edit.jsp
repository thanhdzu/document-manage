            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="doEditBusiness" method="POST">
                            <input type="hidden" name="idbus" value="${bus.id_business}">
                             <div class="form-group">
                                <label>Category Name</label>
                                <input class="form-control" value="${bus.business_name}" disabled placeholder="Please Enter Category Name" />
                            </div>
                            <div class="form-group">
                                <label>Category Name</label>
                                <input class="form-control" name="txtBusName" placeholder="Please Enter Category Name" />
                            </div>
                              
                            </div>
                            <button type="submit" class="btn btn-default">Business Edit</button>
