            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="doEditCategory" method="POST">
                            <input type="hidden" name="idcate" value="${cat.idcate}">
                             <div class="form-group">
                                <label>Tên lĩnh vực</label>
                                <input class="form-control" value="${cat.catename}" disabled placeholder="Please Enter Category Name" />
                            </div>
                            <div class="form-group">
                                <label>Tên lĩnh vực mới</label>
