                ...
                <div class="row">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="catetable">
                        ...
                        <c:forEach items="${cateList}" var="cate" >
             				...
             				<td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="deleteCategory?id=${cate.idcate}"> Xóa</a></td>
                            <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="editCategory?id=${cate.idcate}">Sửa</a></td>
          					</tr>
       					</c:forEach>	
